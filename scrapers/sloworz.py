...
def main():
    pl_file = open("../data/raw/bilingual/sloworz.pl.txt", "a")
    csb_file = open("../data/raw/bilingual/sloworz.csb.txt", "a")
    csb_sentences_file = open("../data/raw/kashubian_only/sloworz.sentences.csb.txt", "a")
